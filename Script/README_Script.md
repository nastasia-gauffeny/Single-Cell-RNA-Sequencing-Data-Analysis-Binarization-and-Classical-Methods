Dans ce dossiers sont stockées, : 

- Functions : les fonctions modifiées de la librairie scMiko à importer de manière supplémentaire afin de diposer de fonctions compatibles mises à jour à la version de Seurat utilisée
